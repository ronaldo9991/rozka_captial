...
import { Loader2, Shield, Lock, AlertTriangle, Eye, EyeOff } from "lucide-react";
    ...
    <div className="min-h-screen flex relative">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden z-10">
        ...
        <div className="relative z-10 flex flex-col justify-center p-12 xl:p-16">
          ...
          >
            <Logo size="lg" />
            <p className="text-primary text-sm font-semibold mt-2 uppercase tracking-wider">SECURE ADMIN PORTAL</p>
          </motion.div>
          ...
          >
            Enhanced security for your admin access.
          </motion.h1>
          ...
          >
            Secondary secure access point with advanced authentication and monitoring capabilities.
          </motion.p>
        </div>
      </div>
          ...
          <Card className="bg-black/40 backdrop-blur-md border border-gray-700/50 p-6 sm:p-8 shadow-2xl">
            <div className="mb-6">
              ...
              <div className="flex items-center gap-2 text-primary/80 mb-2">
                ...
                <p className="text-xs font-semibold">Enhanced Security Mode</p>
              </div>
              <p className="text-gray-400 text-sm">
                Secondary secure access point for administrators
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  data-testid="input-secure-admin-username"
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    data-testid="input-secure-admin-password"
                  />
                  <button
                    type="button"
              ...
              <Button
                ...
                data-testid="button-secure-admin-login"
              >
                {isLoading ? (
                  <>
            ...
            <div className="mt-6 text-center text-xs text-gray-500">
              <p className="font-semibold">ROZKA CAPTIALS Limited Administration</p>
