...
export default function PartnershipCards() {
  ...
  const partnerships = [
    {
      icon: Users,
      image: "/binofox ib.jpg",
      label: "IB",
      sublabel: "Introducing Broker",
      title: "Binofox IB",
      description: "Binofox IB's revenue sharing model will help your business grow beyond benchmark.",
      accentColor: "bg-primary",
      link: "/contact",
    },
    {
      icon: TrendingUp,
      image: "/binofox support.jpg",
      label: "",
      sublabel: "",
      title: "Binofox Support",
      description: "Our Binofox team will analyse your customer and business structure to setup the most rewarding and efficient solution.",
      accentColor: "bg-primary",
      link: "/contact",
    },
    {
      icon: Droplet,
      image: "/binofox prime.jpg",
      label: "POP",
